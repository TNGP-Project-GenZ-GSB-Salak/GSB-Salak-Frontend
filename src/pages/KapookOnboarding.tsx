        ...
        <div className="flex flex-col px-5 pb-3">
          ...
          <div className="kyc-review-card">
            ...
            <div className="kyc-field-grid">
              ...
              <Field label="หมายเลขหลังบัตรประชาชน" value={idNumber} />
            </div>
      ...
      {step === "terms" && (
        <div className="flex flex-col gap-1 p-5 pb-24">
          ...
          <p className="terms-page__clause">
            ...
            ธนาคารออมสินสาขา หรือช่องทางอื่นใดที่ธนาคารกำหนด โดยผู้ใช้บริการจะต้องมีบัญชีเงินฝากประเภทเผื่อเรียกของธนาคารออมสินสาขาใดก็ได้ที่เป็นชื่อของตนเองเป็นบัญชีหลักโอนสำหรับโอนเงินเมื่อมีการถอนเงินออกจากกระปุกออม
          ...
          <p className="terms-page__clause">
            ...
            และผู้ฝากสามารถถอนเงินออมได้โดยไม่มีค่าธรรมเนียม จำนวนไม่เกิน 2 ครั้งต่อปี ต่อการเปิดกระปุกเป้าหมายการออม
